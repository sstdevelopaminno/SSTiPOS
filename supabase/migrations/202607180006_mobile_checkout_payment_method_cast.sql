...
begin
  ...
  values (
    p_tenant_id, p_branch_id, v_order.id, v_db_payment_method::public.payment_method, v_total,
...
comment on function public.mobile_takeaway_checkout_bill(uuid, uuid, uuid, uuid, text, uuid, text, numeric, text, text, numeric, jsonb) is
  'Finalizes a mobile takeaway draft order and casts mobile payment method values into public.payment_method.';
...
grant execute on function public.mobile_takeaway_checkout_bill(uuid, uuid, uuid, uuid, text, uuid, text, numeric, text, text, numeric, jsonb) to authenticated, service_role;
