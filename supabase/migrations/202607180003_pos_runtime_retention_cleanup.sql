...
comment on function public.cleanup_pos_runtime_data(integer, integer, integer) is
  'Deletes expired or old POS runtime records. Intended for scheduled/admin service-role execution.';
